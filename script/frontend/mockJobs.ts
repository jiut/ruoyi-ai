...
具备创新思维和学习能力。`,
    ...
    skillsRequired: '["sketch", "figma", "ui_design", "design_system", "mobile_design"]',
    enterpriseId: 3,
    status: 'PUBLISHED' as JobStatus,
...
具备团队协作精神和责任心。`,
    ...
    educationRequired: '本科及以上',
    profession: 'GRAPHIC_DESIGNER' as Profession,
    skillsRequired: '["3d_max", "maya", "photoshop", "game_art", "character_design", "scene_design"]',
    enterpriseId: 4,
    status: 'PUBLISHED' as JobStatus,
...
具备良好的沟通能力和创新思维。`,
    ...
    skillsRequired: '["figma", "sketch", "axure_rp", "product_design", "user_research", "prototype_design"]',
    enterpriseId: 5,
    status: 'PUBLISHED' as JobStatus,
    publishDate: '2025-01-25',
    deadline: '2025-02-25',
...
具备创意思维和执行能力。`,
    ...
    skillsRequired: '["after_effects", "cinema_4d", "lottie", "motion_design", "animation_design"]',
    enterpriseId: 6,
    status: 'PUBLISHED' as JobStatus,
