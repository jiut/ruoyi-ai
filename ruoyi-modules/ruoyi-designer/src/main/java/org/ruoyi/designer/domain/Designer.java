...
public class Designer extends BaseEntity {
     ...
     * 职业（插画师、交互设计师等）
     */
    @Pattern(regexp = "^(UI_DESIGNER|UX_DESIGNER|UI_UX_DESIGNER|VISUAL_DESIGNER|INTERACTION_DESIGNER|PRODUCT_DESIGNER|BRAND_DESIGNER|MOTION_DESIGNER|THREE_D_DESIGNER|GRAPHIC_DESIGNER|WEB_DESIGNER|ILLUSTRATOR|INTERIOR_DESIGNER|ARCHITECT|LANDSCAPE_DESIGNER)$", 
